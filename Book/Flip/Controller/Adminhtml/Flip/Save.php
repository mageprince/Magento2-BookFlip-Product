...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (!$model->getId() && $id) {
                $this->messageManager->addError(__('This Book no longer exists.'));
            ...
            if (isset($_FILES['upload']) && $_FILES['upload']['name'] != '') {
                ...
                if ($res === TRUE) {
                  ...
                  $this->messageManager->addErrorMessage('Something went wrong while saving the Book.');
                   return $resultRedirect->setPath('*/*/');
                }
            ...
            $model->setData($data);
                ...
                $this->messageManager->addErrorMessage($e, __('Something went wrong while saving the Book.'));
            }
